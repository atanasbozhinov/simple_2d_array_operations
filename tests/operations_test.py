...
class OperationsTests(unittest.TestCase):
    def test_append(self):
        ...
        test_output = matrix_operations.append(input_x, input_y)
    ...
    def test_combine(self):
        ...
        test_output = matrix_operations.combine(input_x, input_y)
    ...
    def test_sum(self):
        ...
        test_output = matrix_operations.sum(input_x, input_y)
